...
namespace Logic
{
	...
	enum TokenType{ TokenType_KEYWORD, TokenType_SEPERATOR, TokenType_BRACKET, TokenType_WORD, TokenType_PARAM, TokenType_VAR, TokenType_FLOW, TokenType_COND, TokenType_BODY, TokenType_NA };
